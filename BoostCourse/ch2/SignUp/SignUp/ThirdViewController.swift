...
//        formatter.dateStyle = .medium
    ...
    @IBAction func touchUpSignupButton(_ sender: UIButton) {
        ...
        if birthDisplay.text != "MM-dd-yyyy" {
            ...
            // SecondViewController 에서 입력한 id,pw 메인화면 전달
            // 스크린에 다시 등장하는 시점에서 값을 읽어와야 하므로 viewWillAppear(_:) 메서드에 읽어오는 소스를 삽입해야 된다.
            
            // 이렇게 하면 오류..
            
//            guard let main = self.storyboard?.instantiateViewController(withIdentifier: "MainVC") as? ViewController else {
//                return
//            }
//
//            main.idField.text = UserModel.shared.id
//            main.pwField.text = UserModel.shared.pw
